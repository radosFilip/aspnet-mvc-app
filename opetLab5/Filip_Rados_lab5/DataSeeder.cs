...
namespace Filip_Rados_lab5
{
    public class DataSeeder
    {
        ...
        public static void Run()
        {
            ...
            var user3 = new User { Id = 3, FirstName = "Petra", LastName = "Kovaè", Username = "petra_k", Email = "petra@mail.com", DateOfBirth = new DateTime(2000, 1, 8) };
            ...
            var post2 = new Post { Id = 2, Title = "Kako uštedjeti 200€ mjeseèno", Content = "...", Category = PostCategory.Finance, CreatedAt = new DateTime(2026, 1, 15), AuthorId = 1, Author = user1 };
            ...
            // ===== KREIRANJE KOMENTARA =====
            var comment1 = new Comment { Id = 1, Content = "Odlièni savjeti!", CreatedAt = new DateTime(2026, 1, 11), AuthorId = 2, Author = user2, PostId = 1, Post = post1 };
            ...
            var comment7 = new Comment { Id = 7, Content = "Preporuèujem svima!", CreatedAt = new DateTime(2026, 3, 11), AuthorId = 3, Author = user3, PostId = 8, Post = post8 };
            var comment8 = new Comment { Id = 8, Content = "Odlièna aplikacija!", CreatedAt = new DateTime(2026, 3, 12), AuthorId = 1, Author = user1, PostId = 8, Post = post8 };
            ...
            // ===== KREIRANJE PORUKA =====
            var message1 = new Message { Id = 1, Content = "Hej, odlièan post!", SentAt = new DateTime(2026, 1, 12), IsRead = true, SenderId = 2, Sender = user2, ReceiverId = 1, Receiver = user1 };
            ...
            // 4. Sve neproèitane poruke za user1
            ...
            // 7. Prosjeèan broj komentara po postu
            ...
            Console.WriteLine($"\n=== Neproèitane poruke za {user1.UserName}: {unreadMessages.Count} ===");

            Console.WriteLine("\n=== Tag statistike ===");
            tagStats.ForEach(t => Console.WriteLine($"- {t.Name}: {t.PostCount} postova"));

            Console.WriteLine($"\n=== Prosjeèan broj komentara po postu: {avgComments:F1} ===");
